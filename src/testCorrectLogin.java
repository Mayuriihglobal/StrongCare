...
WebElement newPatientButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//p[@class='new-patient-button data-v-tooltip']")));
...
System.out.println("New Patient Button Text: " + newPatientButtonText);
    ...
    System.out.println("Test Failed:system is not displays the drug register for the specific location. Exception: " + e.getMessage());
    
    // Display status log on html report page
    extent.createTest("system is not displays the drug register for the specific location").assignCategory("regression testing").assignDevice("Chrome")
