...
public class DrugRegisterstock {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (String drugName : drugNames) {
            ...
            if (searchCount == 2) {
               ...
               WebElement imprest = wait.until(
                        ExpectedConditions.elementToBeClickable(By.xpath("//button[normalize-space()='Imprest Only']")));
                imprest.click();
        ...
        // Assuming you want to print the content of the element with XPath //td[normalize-space()='4']
