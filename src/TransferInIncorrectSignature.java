  ...
  // Log the pass status
     ...
     try {
      ...
      // Assuming you have already located the WebElement
         WebElement elementmedication = driver.findElement(By.xpath("//p[normalize-space()='Invalid login or password/pin code.']"));
      ...
      // Display status log on html report page
         extent.createTest("Invalid login or password/pin code message is displayed").assignCategory("regression testing").assignDevice("Chrome")
         ...
         // Display status log on html report page
         extent.createTest("Invalid login or password/pin code message is not displayed").assignCategory("regression testing").assignDevice("Chrome")
